...
The mobile app lives in `mobile-app/`. It is a Next.js app, deployed separately from that folder, and uses exported JSON snapshots generated by `python scripts/export_data.py`.
...
│   └── definitions.py
│
├── mobile-app/                  # Next.js mobile app
│   ├── package.json
│   ├── public/data/             # exported JSON snapshots for the app
│   └── src/
│
